...
export declare type CoinpaymentsGetTxMultiOpts = string[];
...
export interface CoinpaymentsCreateTransferMerchantOpts extends CoinpaymentsCreateTransferBaseOpts {
    merchant: string;
}
export interface CoinpaymentsCreateTransferTagOpts extends CoinpaymentsCreateTransferBaseOpts {
    pbntag: string;
}
export declare type CoinpaymentsCreateTransferOpts = CoinpaymentsCreateTransferMerchantOpts | CoinpaymentsCreateTransferTagOpts;
...
export interface CoinpaymentsCreateWithdrawalMerchantOpts extends CoinpaymentsCreateWithdrawalBaseOpts {
    address: string;
}
export interface CoinpaymentsCreateWithdrawalTagOpts extends CoinpaymentsCreateWithdrawalBaseOpts {
    pbntag: string;
}
export declare type CoinpaymentsCreateWithdrawalOpts = CoinpaymentsCreateWithdrawalMerchantOpts | CoinpaymentsCreateWithdrawalTagOpts;
...
export declare type CoinpaymentsCreateMassWithdrawalOpts = CoinpaymentsCreateMassWithdrawalElement[];
