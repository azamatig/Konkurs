...
export declare type CoinpaymentsTagListResponse = CoinpaymentsTagListResponseSingle[];
export declare type CoinpaymentsClaimTagResponse = [];
export declare type CoinpaymentsClaimCouponResponse = [];
export declare type CoinpaymentsRenameTagResponse = [];
export declare type CoinpaymentsUpdateTagProfileResponse = [];
...
export declare type CoinpaymentsGetTxListResponse = string[];
...
export declare type CoinpaymentsGetWithdrawalHistoryResponse = CoinpaymentsGetWithdrawalHistoryResponseSingle[];
export declare type CoinpaymentsDeleteTagResponse = [];
export declare type CoinpaymentsBuyTagResponse = [];
