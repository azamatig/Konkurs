...
var Coinpayments = (function () {
    ...
    Coinpayments.prototype.rates = function (options, callback) {
        ...
        var requestPayload = mappers_1.mapPayload(options, {
            cmd: constants_1.CMDS.RATES,
        });
        return internal_1.request(this.credentials, requestPayload, callback);
    };
    Coinpayments.prototype.createTransaction = function (options, callback) {
        return internal_1.request(this.credentials, mappers_1.mapPayload(options, {
    ...
    Coinpayments.prototype.createMassWithdrawal = function (withdrawalArray, callback) {
        withdrawalArray = withdrawalArray.filter(function (w) { return w.currency && w.amount && w.address; });
        return internal_1.request(this.credentials, mappers_1.mapMassWithdrawalPayload(withdrawalArray, {
    ...
    Coinpayments.prototype.getTxMulti = function (txIdArray, callback) {
        if (!(txIdArray instanceof Array) || !txIdArray.length) {
            var error = new error_1.default('Invalid argument', txIdArray);
            if (callback) {
                return callback(error);
            }
            return Promise.reject(error);
        }
        return internal_1.request(this.credentials, mappers_1.mapGetTxMultiPayload(txIdArray, {
    ...
    Coinpayments.prototype.getBasicInfo = function (callback) {
        return internal_1.request(this.credentials, mappers_1.mapPayload({}, {
